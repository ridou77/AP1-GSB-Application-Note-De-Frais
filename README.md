...
| Champ          | Admin      | Visiteur    | Comptable  |
|----------------|-------------|-------------|------------|
| **Identifiant** | `Jdoe`     | `Ldoe`      | `Cdoe`     |
| **Mot de passe** | `test_mdp` | `test_mdp` | `test_mdp` |
...
> **Remarque :** Pour cette épreuve, la chaîne de connexion est incluse en clair dans le dépôt pour faciliter l'évaluation. Voir la section [Avertissement de sécurité](#️-avertissement-de-sécurité--contexte-dépreuve) ci-dessous.

---

## Avertissement de sécurité — Contexte d'épreuve

> **Ce déploiement est réalisé dans un cadre strictement pédagogique (épreuve AP1) et ne reflète pas les bonnes pratiques d'un environnement de production.**
...
| **Hachage SHA256 sans sel (salt)** | SHA256 seul reste vulnérable aux attaques par tables arc-en-ciel. |
...
- **Hachage renforcé** avec bcrypt ou Argon2 (avec sel aléatoire par utilisateur)
...
*Ce projet a été réalisé dans le cadre du BTS SIO — Épreuve AP1.*
