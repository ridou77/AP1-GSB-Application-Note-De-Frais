namespace GSB_demo.Views
{
    partial class AddUserForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBox_SelectUserRole.Location = new Point(244, 146);
            comboBox_SelectUserRole.Margin = new Padding(3, 2, 3, 2);
            comboBox_SelectUserRole.Name = "comboBox_SelectUserRole";
            comboBox_SelectUserRole.Size = new Size(200, 23);
            comboBox_SelectUserRole.TabIndex = 1;
            // 
            // lbl_UserRole
            // 
            lbl_UserRole.AutoSize = true;
            lbl_UserRole.Location = new Point(114, 148);
            lbl_UserRole.Name = "lbl_UserRole";
            lbl_UserRole.Size = new Size(113, 15);
            lbl_UserRole.TabIndex = 2;
            lbl_UserRole.Text = "Role de l'utilisateur :";
            // 
            // txtBox_UserName
            // 
            txtBox_UserName.Location = new Point(244, 95);
            ...
            lbl_UserName.Location = new Point(196, 98);
            lbl_UserName.Name = "lbl_UserName";
            lbl_UserName.Size = new Size(40, 15);
            ...
            lbl_IdConnect.Location = new Point(80, 200);
            lbl_IdConnect.Name = "lbl_IdConnect";
            lbl_IdConnect.Size = new Size(146, 15);
            ...
            lbl_EmailUser.Location = new Point(192, 174);
            lbl_EmailUser.Name = "lbl_EmailUser";
            lbl_EmailUser.Size = new Size(42, 15);
            ...
            lbl_FirstNameUser.Location = new Point(180, 124);
            lbl_FirstNameUser.Name = "lbl_FirstNameUser";
            lbl_FirstNameUser.Size = new Size(55, 15);
            ...
            lbl_MdpUser.Location = new Point(147, 224);
            lbl_MdpUser.Name = "lbl_MdpUser";
            lbl_MdpUser.Size = new Size(83, 15);
            lbl_MdpUser.TabIndex = 8;
            lbl_MdpUser.Text = "Mot de passe :";
            // 
            // txtBox_FirstName
            // 
            txtBox_FirstName.Location = new Point(244, 122);
            txtBox_FirstName.Margin = new Padding(3, 2, 3, 2);
            txtBox_FirstName.Name = "txtBox_FirstName";
            txtBox_FirstName.Size = new Size(200, 23);
            txtBox_FirstName.TabIndex = 9;
            // 
            // txtBox_Email
            // 
            txtBox_Email.Location = new Point(244, 172);
            txtBox_Email.Margin = new Padding(3, 2, 3, 2);
            txtBox_Email.Name = "txtBox_Email";
            txtBox_Email.Size = new Size(200, 23);
            txtBox_Email.TabIndex = 10;
            // 
            // txt_BoxIdConnect
            // 
            txt_BoxIdConnect.Location = new Point(244, 200);
            txt_BoxIdConnect.Margin = new Padding(3, 2, 3, 2);
            txt_BoxIdConnect.Name = "txt_BoxIdConnect";
            txt_BoxIdConnect.Size = new Size(200, 23);
            txt_BoxIdConnect.TabIndex = 11;
            // 
            // txtBox_MdpUser
            // 
            txtBox_MdpUser.Location = new Point(244, 224);
            txtBox_MdpUser.Margin = new Padding(3, 2, 3, 2);
            txtBox_MdpUser.Name = "txtBox_MdpUser";
            txtBox_MdpUser.Size = new Size(200, 23);
            txtBox_MdpUser.TabIndex = 12;
            // 
            // btn_CreateUser
            // 
            btn_CreateUser.Location = new Point(507, 271);
            btn_CreateUser.Margin = new Padding(3, 2, 3, 2);
            btn_CreateUser.Name = "btn_CreateUser";
            btn_CreateUser.Size = new Size(124, 44);
